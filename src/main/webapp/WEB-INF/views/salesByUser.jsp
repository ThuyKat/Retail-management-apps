...
<jsp:include page="navbar.jsp" />
    ...
    <form id="reportForm" onsubmit="return fetchData();">
        ...
        <label for="user">SalesPerson:</label>
    ...
    <script>
        ...
        function fetchData() {
            ...
            const url = new URL('/report/salesByUser/data', window.location.origin);
    ...
    <jsp:include page="salesByUserChart.jsp" />
